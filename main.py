...
if __name__ == "__main__":
    ...
    print(f"Total quantum clock cycles required: {total_quantum_cycles}")
    print(f"Estimated quantum runtime at 1MHz clock speed: {total_quantum_cycles/1e6:.6f} seconds")
    print(f"Classical computation time: {(perf_counter_ns() - starting_time) / 1e9:.6f} seconds")